...
public class QBF implements Evaluator<Integer> {
	...
	/**
	 * The constructor for QuadracticBinaryFunction class. The filename of the input
	 * for setting matrix of coefficients A of the QBF. The dimension of the array
	 * of variables x is returned from the {@link #readInput} method.
	 * 
	 * @param filename Name of the file containing the input for setting the QBF.
	...
	/**
	 * Evaluates the value of a solution by transforming it into a vector. This is
	 * required to perform the matrix multiplication which defines a QBF.
	 * 
	...
	/**
	 * {@inheritDoc} In the case of a QBF, the evaluation correspond to computing a
	 * matrix multiplication x'.A.x. A better way to evaluate this function when at
	 * most two variables are modified is given by methods
	...
	/**
	 * Determines the contribution to the QBF objective function from the insertion
	 * of an element.
	 * 
	 * @param i Index of the element being inserted into the solution.
	 * @return Ihe variation of the objective function resulting from the insertion.
	 */
	...
	/**
	 * Determines the contribution to the QBF objective function from the removal of
	 * an element.
	 * 
	 * @param i Index of the element being removed from the solution.
	 * @return The variation of the objective function resulting from the removal.
	 */
	...
	/**
	 * Determines the contribution to the QBF objective function from the exchange
	 * of two elements one belonging to the solution and the other not.
	 * 
	 * @param in  The index of the element that is considered entering the solution.
	 * @param out The index of the element that is considered exiting the solution.
	 * @return The variation of the objective function resulting from the exchange.
	 */
	...
	/**
	 * Determines the contribution to the QBF objective function from the insertion
	 * of an element. This method is faster than evaluating the whole solution,
	 * since it uses the fact that only one line and one column from matrix A needs
	 * to be evaluated when inserting a new element into the solution. This method
	 * is different from {@link #evaluateInsertionQBF(int)}, since it disregards the
	 * fact that the element might already be in the solution.
	 * 
	 * @param i index of the element being inserted into the solution.
	 * @return the variation of the objective function resulting from the insertion.
	 */
	...
	/**
	 * Responsible for setting the QBF function parameters by reading the necessary
	 * input from an external file. this method reads the domain's dimension and
	 * matrix {@link #A}.
	 * 
	 * @param filename Name of the file containing the input for setting the black
	 *                 box function.
	...
	/**
	 * Reserving the required memory for storing the values of the domain variables.
	 * 
