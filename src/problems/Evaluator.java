...
public interface Evaluator<E> {
	...
	/**
	 * The evaluating function is responsible for returning the mapping value of a
	 * solution.
	 * 
	 ...
	 * @param sol  the solution for which the element insertion is being evaluated.
	...
	/**
	 * Evaluates the cost variation of removing an element into a solution according
	 * to an objective function.
	 * 
	 * @param elem the element under consideration for removal.
	 * @param sol  the solution for which the element insertion is being evaluated.
	 * @return the cost variation resulting from the element removal pf the
	 *         solution.
	 */
	public abstract Double evaluateRemovalCost(E elem, Solution<E> sol);

	/**
	 * Evaluates the cost variation of exchanging candidates, one being considered
	 * to enter the solution (elemIn) and the other being considered for removal
	 * (elemOut).
	 * 
